...
var app, base, concat, directory, gulp, gutil, hostname, path, refresh, sass, uglify, imagemin, minifyCSS, del, browserSync, autoprefixer, gulpSequence, shell, sourceMaps, plumber, spritesmith, buffer, mergequery;
...
gulp.task('sprite', function () {
  ...
  return spriteData.css
    .pipe(gulp.dest('app/styles/scss/base'));
});
